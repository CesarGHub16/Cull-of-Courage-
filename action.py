...
class ActionWithDir(Action):
    ...
    def blocking_entity(self) -> Optional[Entity]:
        ...
        return self.engine.game_map.get_blocking_at_location(*self.dest_xy)
    @property
...
class MeleeAction(ActionWithDir):
    def perform(self) -> None:
        ...
        damage = self.entity.fighter.AD - (target.fighter.AR // 1)
...
class MovementAction(ActionWithDir):
    def perform(self) -> None:
        ...
        if self.engine.game_map.get_blocking_at_location(dest_x,dest_y):
